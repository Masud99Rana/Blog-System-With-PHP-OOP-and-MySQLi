...
# Blog System With PHP OOP and MySQLi
> **Note:** This repository contains the core code of a Blog System With PHP OOP and MySQLi.
...
## About The Project
A blog (a truncation of "weblog") is a discussion or informational website published on the World Wide Web consisting of discrete, often informal diary-style text entries (posts). In this project, I have practiced how to make a real world blog system using PHP, OOP, MySQL
...
1. Clone the repo
```sh
git remote add origin https://github.com/Masud99Rana/Blog-System-With-PHP-OOP-and-MySQLi.git
```
